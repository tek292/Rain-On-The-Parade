...
import com.riis.rainontheparade.data.WeatherContract;
...
public class TestWeatherDataParser extends AndroidTestCase
{
    ...
    public void testAddLocation()
    {
        ...
        long locationId = weatherDataParser.addLocation(ADD_LOCATION_SETTING, ADD_LOCATION_CITY,
        ...
        for (int i = 0; i < 2; i++)
        {
            ...
            long newLocationId = weatherDataParser.addLocation(ADD_LOCATION_SETTING, ADD_LOCATION_CITY,
                    ADD_LOCATION_LAT, ADD_LOCATION_LON);
